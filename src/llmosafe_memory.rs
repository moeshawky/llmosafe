...
impl<const SIZE: usize> WorkingMemory<SIZE> {
    ...
    pub fn trend(&self) -> f64 {
        let n = SIZE as f64;
        // Optimization: Defer floating-point conversions.
        // Accumulate as i128 to optimize tight loop and reduce floating-point roundoff errors.
        // CognitiveEntropy::mantissa() returns i128.
