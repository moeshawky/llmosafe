...
impl<const SIZE: usize> WorkingMemory<SIZE> {
    ...
    pub fn trend(&self) -> f64 {
        let n = SIZE as f64;
        // ⚡ Bolt: Accumulate using i128 integers inside the loop instead of f64.
        // This avoids redundant float conversions in the tight loop and prevents
        // floating-point roundoff error accumulation. Conversions to f64 are deferred.
