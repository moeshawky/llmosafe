...
//! model produces `INTERCEPT = 2.673815` and empty vocab.
//!
...
//!
//! The INTERCEPT value (2.673815) is retained for fail-closed mode.
//! However, `is_manipulation` is NOT set by INTERCEPT alone when
//! matched==0. The `no_evidence` flag carries the zero-match signal.
