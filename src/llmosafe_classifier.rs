//! TF-IDF Streaming Classifier — zero allocation, no_std compatible.
//!
//! Core foundation for the v0.7.0 sifter replacement.
//! Vocabulary and model coefficients are embedded at build time via build.rs.
//! Tokenizer and sigmoid are self-contained with no external dependencies.
