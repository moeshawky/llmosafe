...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // Optimization: stream hashing and matching inline within the initial iterator pass
        // to avoid allocating an intermediate ArrayVec and the secondary iteration overhead.
