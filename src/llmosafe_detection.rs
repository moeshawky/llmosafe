...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // Optimization: Perform hashing and matching inline within the `split_whitespace().take(MAX_CONTEXT_LEN)`
        // iterator pass to avoid allocating an intermediate `ArrayVec` and a secondary iteration loop.
