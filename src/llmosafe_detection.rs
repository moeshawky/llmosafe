...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // Optimization: Inline hashing and matching during string splitting pass.
        // This avoids allocating an intermediate ArrayVec and eliminates a secondary loop overhead.
