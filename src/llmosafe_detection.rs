...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // Bolt Optimization: Inline hashing and matching during iteration to avoid intermediate
        // ArrayVec allocation and second loop overhead for better performance.
