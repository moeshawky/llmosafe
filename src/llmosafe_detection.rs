...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // Optimization: Perform string hashing and matching inline within the same iterator pass.
        // This avoids allocating an intermediate ArrayVec collection and secondary loop overhead.
