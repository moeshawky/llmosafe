...
impl DriftDetector {
    ...
    pub fn observe(&mut self, observation: &str) {
        ...
        // ⚡ Bolt: Removed intermediate ArrayVec allocation and secondary loop.
        // Process string tokens and match against goal hashes inline within
        // the single iterator pass.
